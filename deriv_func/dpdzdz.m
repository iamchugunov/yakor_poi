function [f] = dpdzdz(y,x,t,i,j, config)
    ...
    f1 = 1/Sn^2 * y * 1/config.c * (R_t(x, t, X(:,i)) - (z_t(x,t) - X(3,i))^2/R_t(x, t, X(:,i)))/R_t(x, t, X(:,i))^2;
    ...
    f2 = 1/Sn^2 * 1/config.c * ( 1/config.c * (z_t(x,t) - X(3,i))/R_t(x, t, X(:,i)) * (z_t(x,t) - X(3,i))/R_t(x, t, X(:,i)) + S_t(x, t, i, j, config) * f3);
    f = f1 - f2;
end
